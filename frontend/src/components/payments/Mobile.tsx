...
function Mobile() {
  ...
  const presetAmounts = ['5', '10', '15', '25', '30'];
  ...
  return (
    <div className='font-plus'>
      <h1 className="text-2xl text-center font-plus font-bold mt-8 text-text">Mobile Recharge</h1>
      <div className='flex-col flex font-plus space-y-6 p-8 mt-6 max-w-xl mx-auto rounded-2xl'>
        <form className="space-y-6">
          <div className="space-y-6">
            <div>
              <label htmlFor="meterNumber" className="block text-xm font-bold text-text3 mb-1">Choose account/ card</label>
              <select
            ...
            <div>
                <label className="block text-sm font-bold text-text3 mb-2">Phone Number</label>
              <input
                type="tel"
                className="w-full p-3 border border-[#CBCBCB] rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
